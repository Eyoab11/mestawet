          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && "hidden"}`}>
              <Link
                ...
                className={`h-12 bg-gray-200 px-5 text-black flex-center gap-2 rounded-lg ${
        ...
        <div className="flex max-w-5xl w-full">
          <Link
            ...
            className={`profile-tab rounded-l-lg ${
              pathname === `/profile/${id}` && "!bg-gray-200"
            }`}>
            <img
              src={"/assets/icons/postsicon.svg"}
              alt="posts"
              width={20}
              height={20}
            />
          ...
          <Link
            ...
            className={`profile-tab rounded-r-lg ${
              pathname === `/profile/${id}/liked-posts` && "!bg-gray-200"
            }`}>
            <img
              src={"/assets/icons/likedicon.svg"}
              alt="like"
              width={20}
              height={20}
            />
