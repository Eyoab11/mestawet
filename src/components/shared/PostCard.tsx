    ...
    <div className="post-card">
        <div className="flex-between">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex-center gap-2 text-">
            ...
            <img src="/assets/icons/editicon.svg" alt="edit" width={20} height={20} />
            </Link>
        </div>
        <Link to={`/posts/${post.$id}`}>
            ...
            <img src={post.imageUrl || '/assets/icons/profile-placeholder.svg'} alt="" className="post-card_img"/>
        </Link>
